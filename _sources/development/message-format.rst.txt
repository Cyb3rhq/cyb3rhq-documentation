...
.. meta::
  :description: This section contains instructions to describe the Standard OSSEC message format Cyb3rhq accepts and sends between its components.
...
This page aims to describe the format of messages that OSSEC (and Cyb3rhq) accepts and sends between its components:
