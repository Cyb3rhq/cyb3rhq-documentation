...
.. meta::
  :description: Check out this section of our documentation to learn about Available SCA policies in Cyb3rhq.


Available SCA policies
======================

The table below shows SCA policies pre-installed in Cyb3rhq out-of-the-box. The Cyb3rhq agent only installs the policy file that is applicable to the endpoint operating system:
