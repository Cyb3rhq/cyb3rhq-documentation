...
.. meta::
  :description: Learn more about how to create custom Security Configuration Assessment (SCA) policies in Cyb3rhq and discover some examples. 
...
<https://github.com/cyb3rhq/cyb3rhq-qa/tree/master/tests/legacy/test_sca/test_basic_usage/data>`_.
