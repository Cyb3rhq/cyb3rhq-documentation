...
.. meta::
  :description: Learn more about how the Security Content Automation Protocol (SCAP) works and its requirements in this section of the Cyb3rhq documentation.
...
These are the Security Policy included by default on Cyb3rhq:
