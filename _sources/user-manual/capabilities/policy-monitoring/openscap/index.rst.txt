...
.. meta::
  :description: The OpenSCAP wodle is an integration of OpenSCAP with Cyb3rhq. Learn how to perform configuration and vulnerability scans of an agent with Cyb3rhq and OpenSCAP here. 
...
The **OpenSCAP wodle** is an integration of `OpenSCAP <https://www.open-scap.org/>`_ with *Cyb3rhq HIDS* that provides the ability to perform configuration and vulnerability scans of an agent. It is primarily used for:
