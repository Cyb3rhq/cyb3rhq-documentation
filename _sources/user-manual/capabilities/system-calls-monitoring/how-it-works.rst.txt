...
.. meta::
   :description: This guide will teach you about monitoring system calls with Cyb3rhq: control rules, file system rules, and system call rules. 
...
|                      |                                                                                                                                                                 |
|                      | Cyb3rhq requires this argument to analyze the logs more accurately.                                                                                               |
+----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------+
