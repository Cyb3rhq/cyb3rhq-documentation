...
.. meta::
  :description: The Cyb3rhq FIM module monitors directories to detect file changes, additions, and deletions. Discover some FIM use cases in this section of our documentation. 
...
You can configure the FIM module to monitor configuration files and report any changes. The Cyb3rhq FIM module uses the :ref:`whodata <who-data-monitoring>` and :ref:`report_changes <reporting-changes-in-registry-values>` attributes to record the following information about such changes:
...
Navigate to **File Integrity Monitoring** on the Cyb3rhq dashboard to view the alert generated when the FIM module detects modification of the configuration file.
