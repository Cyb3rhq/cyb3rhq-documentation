...
.. meta::
  :description: Learn more about client configuration, connection to the manager, and its configuring options in this section of the Cyb3rhq documentation.
...
Specifies the IP address or the hostname of the Cyb3rhq manager.
...
+--------------------+-----------------------------+
 ...
 .. note:: Most systems won't need to modify this value, but on systems with large routing tables this configuration can help lower CPU usage from cyb3rhq-modulesd.
...
Specifies the port on the manager to send enrollment request.  This must match the associated listening port configured on the Cyb3rhq manager.
