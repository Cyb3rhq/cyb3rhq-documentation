...
.. meta::
  :description: Find out how to configure the Cyb3rhq database_output feature. Learn more about it in this section of the Cyb3rhq documentation.
...
.. note::
   ...
   To use this output feature, Cyb3rhq must be compiled with the database type that is to be used. Read :ref:`this article <configuring_database_output>` to learn about how to install and enable it.
