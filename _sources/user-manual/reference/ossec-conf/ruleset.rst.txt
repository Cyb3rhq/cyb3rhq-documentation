...
.. meta::
  :description: Find out more about the configuration options for enabling or disabling rules and decoders with Cyb3rhq.
...
.. note::
    ...
    Do not include the file extension. Since Cyb3rhq v3.11.0, Cyb3rhq will build and load the CDB lists automatically when the analysis engine starts.
