...
.. meta::
  :description: Find out how to configure the Cyb3rhq GitHub module. Learn more about it in this section of the Cyb3rhq documentation.
...
By default, when Cyb3rhq starts it will only read all log content from GitHub since the manager started.
