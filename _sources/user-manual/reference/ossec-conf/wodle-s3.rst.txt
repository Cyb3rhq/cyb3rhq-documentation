...
.. meta::
    :description: Learn more about the local configuration of Cyb3rhq. In this section of the documentation you can learn more about the configuration options of the Cyb3rhq integration with AWS.
...
Run the module immediately after the Cyb3rhq service starts.
