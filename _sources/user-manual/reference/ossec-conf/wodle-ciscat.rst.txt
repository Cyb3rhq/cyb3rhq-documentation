...
.. meta::
  :description: Find out the configuration options of the cis-cat wodle. Learn more about it in this section of the Cyb3rhq documentation.
...
.. warning::
    For this field, it can be set as a full path or a relative path. Whether you specify a relative path, it concatenates with the Cyb3rhq installation path. ``ciscat_path`` has the same behavior.
