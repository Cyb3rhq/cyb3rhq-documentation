...
.. meta::
  :description: Learn more about the available options and how to configure the vulnerability detection module of Cyb3rhq in this section of our documentation.
...
.. topic:: XML section name
   ...
   .. note::
      ...
      In Cyb3rhq 4.8.0, we rename the previous ``<vulnerability-detector>`` tag to ``<vulnerability-detection>``.
