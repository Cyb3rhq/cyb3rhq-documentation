...
.. meta::
  :description: Find out how to configure the Cyb3rhq cluster for manager synchronization. Learn more about it in this section of the Cyb3rhq documentation.
...
This section explains how to configure the Cyb3rhq cluster for manager synchronization.
...
Defines the key used to encrypt the communication between the nodes. This key must be 32 characters long. Refer to the :ref:`configuring-cluster <cyb3rhq_cluster_nodes_configuration>` for information on how to generate a key.
...
+--------------------+-------------------------------------+
| **Default value**  | cyb3rhq_reporting                     |
+--------------------+-------------------------------------+
...
.. code-block:: xml
    ...
    <cluster>
      ...
      <haproxy_helper>
        ...
        <haproxy_address>cyb3rhq-proxy</haproxy_address>
        ...
        <haproxy_backend>cyb3rhq_cluster</haproxy_backend>
