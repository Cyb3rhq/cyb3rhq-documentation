...
.. meta::
  :description: The Cyb3rhq GCP Storage module allows you to process logs stored in Google Cloud Storage buckets. Learn more about how to configure the module in this section.
...
.. topic:: Bucket options
   ...
   |                                        | It can be absolute or relative to ``CYB3RHQ_HOME``            |                                               |
   +----------------------------------------+-------------------------------------------------------------+-----------------------------------------------+
...
Path to the Google Cloud credentials file. It can be an absolute path or relative to ``CYB3RHQ_HOME``.
...
Run the module on Cyb3rhq service start or restart.
