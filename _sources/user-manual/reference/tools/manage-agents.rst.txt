...
.. meta::
  :description: The manage_agents program is available in both versions for server and agent installations. Learn more about it in this section of the Cyb3rhq documentation.
...
keys for Cyb3rhq agents. These authentication keys are required for secure (encrypted and
authenticated) communication between the Cyb3rhq server and its affiliated agent instances.
