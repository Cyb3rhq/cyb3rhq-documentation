...
.. meta::
  :description: Find out how to list agents assigned to a group using the agent_groups program. Learn more about it in this section of the Cyb3rhq documentation.
