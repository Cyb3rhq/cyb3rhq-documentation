...
.. meta::
  :description: Learn about the cyb3rhq-logcollector program that monitors configured files and commands for new log messages in this section of the documentation.

.. _cyb3rhq-logcollector:

cyb3rhq-logcollector
==================

The cyb3rhq-logcollector program monitors configured files and commands for new log messages.

``cyb3rhq-logcollector`` is now multi-threaded, achieving an improvement in overall performance. Each of the threads will read the first log that is not already handled by other threads
