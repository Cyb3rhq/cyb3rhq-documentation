...
.. meta::
  :description: Learn how the cyb3rhq-remoted.state file provides information about the remote daemon as the queue size, discarded messages, and other useful information.

.. _cyb3rhq_remoted_state_file:

cyb3rhq-remoted.state
===================

The statistical file for **cyb3rhq-remoted** is located at ``/var/ossec/var/run/cyb3rhq-remoted.state``.
