...
.. meta::
  :description: The cyb3rhq-analysisd.state file can be useful when benchmarking our Cyb3rhq manager analysis engine in highly loaded environments. Learn more about it here.

.. _cyb3rhq_analysisd_state_file:

cyb3rhq-analysisd.state
=====================

The statistical file for **cyb3rhq-analysisd** is located at ``/var/ossec/var/run/cyb3rhq-analysisd.state``.

It can be useful when benchmarking our Cyb3rhq manager analysis engine in highly loaded environments.
