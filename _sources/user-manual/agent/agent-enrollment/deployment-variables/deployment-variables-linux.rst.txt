...
.. meta::
   :description: Learn about the variables used by Cyb3rhq agent packages on Linux endpoints and see examples of how to use them.

Deployment variables for Linux
==============================

Below is a table describing the variables used by Cyb3rhq agent packages on Linux endpoints and a few examples of how to use them.
   ...
   .. tabs::
      ...
      .. group-tab:: Yum
         ...
         .. code-block:: console
            ...
            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_PASSWORD="TopSecret" \
                 CYB3RHQ_AGENT_NAME="yum-agent" yum install cyb3rhq-agent
      ...
      .. group-tab:: APT
         ...
         .. code-block:: console
            ...
            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_PASSWORD="TopSecret" \
                 CYB3RHQ_AGENT_NAME="apt-agent" apt-get install cyb3rhq-agent
      ...
      .. group-tab:: ZYpp
         ...
         .. code-block:: console
            ...
            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_PASSWORD="TopSecret" \
                 CYB3RHQ_AGENT_NAME="zypper-agent" zypper install cyb3rhq-agent
   ...
   .. tabs::
      ...
      .. group-tab:: Yum
         ...
         .. code-block:: console
            ...
            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_SERVER="10.0.0.2" CYB3RHQ_REGISTRATION_PASSWORD="TopSecret" \
                 CYB3RHQ_AGENT_GROUP="my-group" yum install cyb3rhq-agent
      ...
      .. group-tab:: APT
         ...
         .. code-block:: console
            ...
            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_SERVER="10.0.0.2" CYB3RHQ_REGISTRATION_PASSWORD="TopSecret" \
                 CYB3RHQ_AGENT_GROUP="my-group" apt-get install cyb3rhq-agent
      ...
      .. group-tab:: ZYpp
         ...
         .. code-block:: console
            ...
            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_SERVER="10.0.0.2" CYB3RHQ_REGISTRATION_PASSWORD="TopSecret" \
                 CYB3RHQ_AGENT_GROUP="my-group" zypper install cyb3rhq-agent
   ...
   .. tabs::
      ...
      .. group-tab:: Yum
         ...
         .. code-block:: console
            ...
            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_SERVER="10.0.0.2" CYB3RHQ_AGENT_NAME="yum-agent" \
                 CYB3RHQ_REGISTRATION_CA="rootCA.pem" yum install cyb3rhq-agent

      .. group-tab:: APT

         .. code-block:: console

            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_SERVER="10.0.0.2" CYB3RHQ_AGENT_NAME="apt-agent" \
                 CYB3RHQ_REGISTRATION_CA="rootCA.pem" apt-get install cyb3rhq-agent

      .. group-tab:: ZYpp

         .. code-block:: console

            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_SERVER="10.0.0.2" CYB3RHQ_AGENT_NAME="zypper-agent" \
                 CYB3RHQ_REGISTRATION_CA="rootCA.pem" zypper install cyb3rhq-agent
   ...
   .. tabs::
      ...
      .. group-tab:: Yum
         ...
         .. code-block:: console
            ...
            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_SERVER="10.0.0.2" CYB3RHQ_AGENT_NAME="yum-agent" \
                 CYB3RHQ_PROTOCOL="udp" yum install cyb3rhq-agent
      ...
      .. group-tab:: APT
         ...
         .. code-block:: console
            ...
            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_SERVER="10.0.0.2" CYB3RHQ_AGENT_NAME="apt-agent" \
                 CYB3RHQ_PROTOCOL="udp" apt-get install cyb3rhq-agent
      ...
      .. group-tab:: ZYpp
         ...
         .. code-block:: console
            ...
            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_SERVER="10.0.0.2" CYB3RHQ_AGENT_NAME="zypper-agent" \
                 CYB3RHQ_PROTOCOL="udp" zypper install cyb3rhq-agent
   ...
   .. tabs::
      ...
      .. group-tab:: Yum
         ...
         .. code-block:: console
            ...
            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_SERVER="10.0.0.2" CYB3RHQ_REGISTRATION_KEY="/var/ossec/etc/sslagent.key" \
                 CYB3RHQ_REGISTRATION_CERTIFICATE="/var/ossec/etc/sslagent.cert" yum install cyb3rhq-agent
      ...
      .. group-tab:: APT
         ...
         .. code-block:: console
            ...
            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_SERVER="10.0.0.2" CYB3RHQ_REGISTRATION_KEY="/var/ossec/etc/sslagent.key" \
                 CYB3RHQ_REGISTRATION_CERTIFICATE="/var/ossec/etc/sslagent.cert" apt-get install cyb3rhq-agent
      ...
      .. group-tab:: ZYpp
         ...
         .. code-block:: console
            ...
            # CYB3RHQ_MANAGER="10.0.0.2" CYB3RHQ_REGISTRATION_SERVER="10.0.0.2" CYB3RHQ_REGISTRATION_KEY="/var/ossec/etc/sslagent.key" \
                 CYB3RHQ_REGISTRATION_CERTIFICATE="/var/ossec/etc/sslagent.cert" zypper install cyb3rhq-agent
