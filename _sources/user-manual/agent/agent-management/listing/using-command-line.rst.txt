...
.. meta::
   :description: The agent_control tool allows for the retrieval of a list of the available Cyb3rhq agents. Learn more in this section of the documentation.

Listing agents using the CLI
----------------------------

The ``/var/ossec/bin/agent_control`` tool on the Cyb3rhq server, used with ``-l`` option, allows for the retrieval of a list of the available Cyb3rhq agents:
