...
.. meta::
  :description: Advance filtering is possible using the Cyb3rhq dashboard's queries. Learn more about it in this section of the Cyb3rhq documentation.
 
.. _dashboard-queries:

Filtering data using the Cyb3rhq Query Language
=============================================
...
The WQL search bars found in various sections of the Cyb3rhq dashboard, use the Cyb3rhq Query Language to query the API. This language is based on the :ref:`Cyb3rhq API query language <queries>`.

.. thumbnail:: ../../images/cyb3rhq-dashboard/queries/search-bar-wql.png
...
In the Cyb3rhq dashboard, there are specialized search bars for querying Cyb3rhq indexer data. These use the same syntax as OpenSearch. To learn more, refer to `Using Dashboards Query Language <https://opensearch.org/docs/2.10/dashboards/discover/dql/>`__.