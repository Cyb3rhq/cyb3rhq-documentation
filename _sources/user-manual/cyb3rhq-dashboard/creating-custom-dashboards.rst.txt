...
This section describes the process of creating a set of custom visualizations using the Cyb3rhq dashboard component. We also show how to add individually created visualizations together to create a custom dashboard.
...
There are different visualization techniques that can help make data clear and appealing. The Cyb3rhq **Visualize** page takes data from the **Discover** page and turns it into various visual types like Bar, Area, Line Charts, Pie Charts, Maps, and Tables. These visuals can be saved, combined for dashboards, and shared with others using the Cyb3rhq dashboard.

We will cover the practical aspect of dashboard creation by creating different types of visualizations in the Cyb3rhq dashboard and then integrate the visualizations to create a custom dashboard.
...
.. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-new-visualization.png
   :align: center
   :width: 80%
...
.. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/select-visualization-type.png
   :align: center
   :width: 80%
...
.. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/choose-source.png
   :align: center
   :width: 80%
   :title: Choose a source
   :alt: Choose a source

Cyb3rhq dashboard aggregation
~~~~~~~~~~~~~~~~~~~~~~~~~~~

The Cyb3rhq dashboard visualization contains two main aggregation objects;
...
#. **Average**: This is the average of a numeric field. It calculates the arithmetic mean of an existing set of data values. The Average is obtained by adding up all the data values and dividing its sum by the total count.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/average-metric-aggregation.png
      :align: center
      :width: 80%
...
#. **Count**: This is the number of data values that match a query within the selected index pattern. It counts the number of data points in a set and provides the total count of a queried event.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/count-metric-aggregation.png
      :align: center
      :width: 80%
...
#. **Max**: This is the maximum value of a numeric field within a selected index pattern. Max identifies the highest value among a group of values.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/max-metric-aggregation.png
      :align: center
      :width: 80%
...
#. **Median**: This is the median value in a numeric field. Median determines the middle value in a sorted set of values within a selected index pattern by separating the higher half from the lower half of the data.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/median-metric-aggregation.png
      :align: center
      :width: 80%
...
#. **Min**: This is the minimum value in a numeric field set. Min identifies the lowest value among a group of values.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/min-metric-aggregation.png
      :align: center
      :width: 80%
...
#. **Percentile Ranks**: This is the ranking for values within a given numeric field in percentile. Percentile rank calculates the percentage of values below a specific value in a set and expresses how a given value compares to the distribution of the data.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/percentile-ranks-metric-aggregation.png
      :align: center
      :width: 80%
...
#. **Percentile**: This aggregation changes numeric field values into percentile bands. Percentile identifies specific data values that correspond to specific percentiles. For example, the 90th percentile represents the value below which 90% of the data falls.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/percentiles-metric-aggregation.png
      :align: center
      :width: 80%
...
#. **Standard Deviation**: This measures the amount of variation in a set of numeric field values. It evaluates the average distance between each value and the mean value.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/standard-deviation-aggregation.png
      :align: center
      :width: 80%
...
#. **Sum**: This is the total sum of a numeric field. Sum calculates the total sum of a set of values by adding up all the values in the dataset within a selected index pattern.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/sum-aggregation.png
      :align: center
      :width: 80%
...
#. **Top Hit**: This aggregation identifies the top data point based on a specified criteria or sort order. Top hit is commonly used to extract specific information from the dataset based on the top metric.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/top-hit-aggregation.png
      :align: center
      :width: 80%
...
#. **Unique Count**: This is the count of unique values within a designated field. It counts the number of unique or distinct values in a set. Unique count disregards any duplicate event and provides the count of unique values.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/unique-count-aggregation.png
      :align: center
      :width: 80%
...
#. **Cumulative Sum**: This is the calculation of the running sum of a metric across a specified set of data points. It shows the progressive total as each data point is added.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/cumulative-sum-aggregation.png
      :align: center
      :width: 80%
...
#. **Derivative**: This is the calculation of the rate of change of values over time. Derivative is the difference between consecutive values in a time series or dataset.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/derivative-aggregation.png
      :align: center
      :width: 80%
...
#. **Moving Avg**: This is the calculation of the average of a metric over a moving window of data points. It provides a neat representation of the data, hence reducing noise or fluctuations.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/moving-avg-aggregation.png
      :align: center
      :width: 80%
...
#. **Serial Diff**: This is the difference between consecutive values in a time series or ordered dataset. It measures the absolute change from one data point to the next.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/serial-diff-aggregation.png
      :align: center
      :width: 80%
...
#. **Average Bucket**: This is the average value of a metric within each bucket of a specified aggregation. Average bucket provides the average value per group or category.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/average-bucket-aggregation.png
      :align: center
      :width: 80%
...
#. **Max Bucket**: This is the maximum value of a metric within each bucket of a specified aggregation. It identifies the highest value per group.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/max-bucket-aggregation.png
      :align: center
      :width: 80%
...
#. **Min Bucket**: This is the minimum value of a metric within each bucket of a specified aggregation. It identifies the lowest value per group or category.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/min-bucket-aggregation.png
      :align: center
      :width: 80%
...
#. **Sum Bucket**: This is the total sum of a metric within each bucket of a specified aggregation. It adds up the values per group.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/sum-bucket-aggregation.png
      :align: center
      :width: 80%
...
#. **Date Histogram**: This aggregation is used to display a numeric field and organize that using the date.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/date-histogram-aggregation.png
      :align: center
      :width: 80%
...
#. **Date Range**: This aggregation is used to report the values within a date range which we can specify.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/date-range-aggregation.png
      :align: center
      :width: 80%
...
#. **Filters**: This aggregation is used to apply filters on data.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/filters-aggregation.png
      :align: center
      :width: 80%
...
#. **Histogram**: This aggregation is used for numeric fields, where we can provide the integer interval for the selected field.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/histogram-aggregation.png
      :align: center
      :width: 80%
...
#. **IPv4 Range**: This aggregation provides us with the option to set the range using IPv4 addresses.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/ipv4-range-aggregation.png
      :align: center
      :width: 80%
...
#. **Range**: This aggregation is used to provide the range of numeric field values.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/range-aggregation.png
      :align: center
      :width: 80%
...
#. **Significant Terms**: This aggregation returns interesting or unusual occurrences of terms in a set.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/significant-terms-aggregation.png
      :align: center
      :width: 80%
...
#. **Terms**: This aggregation enables us to pick the top or bottom n elements of the selected field.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/terms-aggregation.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Horizontal bar`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-horizontal-bar-visualization.png
      :align: center
      :width: 80%
...
#. Click the **Update** button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-horizontal-bar-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, select the ``Vertical Bar`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-vertical-bar-visualization.png
      :align: center
      :width: 80%
...
#. Click the **Update** button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-vertical-bar-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Pie`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-pie-visualization.png
      :align: center
      :width: 80%
...
#. Click the **Update** button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-pie-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``area`` visualization format, and use ``cyb3rhq-alerts-*`` as the index pattern name.

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-area-visualization.png
      :align: center
      :width: 80%
...
#. Click the **Update** button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-area-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Line`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name. 
...
#. Click the **Update** button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-line-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Heat Map`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-heat-map-visualization.png
      :align: center
      :width: 80%
...
#. Click the **Update** button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-heat-map-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Data Table`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name. 
...
#. Click the **Update** button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-data-table-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Metric`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.
#. On the **Metric** in **Metrics** data, set the following values:
...
#. Click the **Update** button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-metric-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Goal`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.
...
#. In the ``Options`` section, customize the ``Ranges`` to match the range of existing sca rules.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-goal-visualization.png
      :align: center
      :width: 80%
...
#. Click the **Update** button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-goal-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Gauge`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.
#. On the **Metric** in **Metrics** data, set the following values:
...
#. Click the Update button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-gauge-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Maps`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-map-visualization.png
      :align: center
      :width: 80%
...
#. Click on **Add layer**.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-map-visualization-add-layer.png
      :align: center
      :width: 80%
...
#. Set the following values in the New layer:
   ...
   -  ``Data source`` = ``cyb3rhq-alerts-*``
   -  ``Geospatial field`` = ``GeoLocation.location``
   -  ``Number of documents`` = ``1000``

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-map-visualization-new-layer.png
      :align: center
      :width: 80%
...
#. Click the **Update** button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-map-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Coordinate Map`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-coordinate-map-visualization.png
      :align: center
      :width: 80%
...
#. Click the **Update** button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-coordinate-map-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Region Map`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-region-map-visualization.png
      :align: center
      :width: 80%
...
#. Click the **Update** button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-region-map-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``VisBuilder`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-visbuilder-visualization.png
      :align: center
      :width: 80%
...
#. On the split series place ``rule.mitre.tactic``.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-visbuilder-visualization-data.png
      :align: center
      :width: 80%
...
Time Series Visual Builder (TSVB) is a component of the Cyb3rhq dashboard that allows users to create visualizations and analyze time series data using a visual pipeline interface. It provides features such as aggregations, filters, and metrics specifically tailored for time-based analysis.
...
#. From the **Visualize** tab, select the ``TSVB`` visualization format.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-tsvb-visualization.png
      :align: center
      :width: 80%
...
#. On the **Metric** in **Data**, set the following values:
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-tsvb-visualization-data.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Tag cloud`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-tag-cloud-visualization.png
      :align: center
      :width: 80%
...
#. Click the **Update** button.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-tag-cloud-visualization-update-button.png
      :align: center
      :width: 80%
...
From the **Visualize** tab, click **Create Visualization**, select the ``Markdown`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.

.. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-markdown-visualization.png
   :align: center
   :width: 80%
...
#. Click on the **Update** button to show the markdown:
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-markdown-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Controls`` visualization format.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-controls-visualization.png
      :align: center
      :width: 80%
...
#. Choose a source for the chart. Here we selected ``cyb3rhq-alerts-*`` as the index to use.
#. Select the field ``rule.mitre.tactic``.
#. Add a new ``Range slider`` and set the control Label as Quantity.
#. Select ``cyb3rhq-alerts-*`` as the index to use.
#. Select the field ``rule.level``.
#. Click the **Update** button.

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-controls-visualization-update-button.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Gantt Chart`` visualization format and use ``cyb3rhq-alerts-*`` as the index pattern name.

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-gantt-chart-visualization.png
      :align: center
      :width: 80%
...
#. From the **Visualize** tab, click **Create Visualization**, select the ``Timeline`` visualization format.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-timeline-visualization.png
      :align: center
      :width: 80%
      :title: Create timeline visualization
      :alt: Create timeline visualization

#. Choose a source for the chart. In the Timeline expression windows, within ``.opensearch(*)``. The expression ``.opensearch(*)`` is a wildcard value that represents all the indexes currently within the Cyb3rhq indexer, combined together. Here we selected ``cyb3rhq-alerts-*`` as the index to use.

   .. code-block:: none

      .opensearch(index=cyb3rhq-alerts-*)

   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-timeline-visualization-source.png
      :align: center
      :width: 80%
   ...
   A sample query:
      ...
      .. code-block:: none
         ...
         .opensearch(index=cyb3rhq-alerts-*, timefield=@timestamp, metric=count:request).aggregate(function=avg)
...
#. Click on the upper-left menu icon and navigate to **Explore** > **Dashboards** > **Create new dashboard**.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-new-dashboard.png
      :align: center
      :width: 80%
...
#. Click **Add an existing** and select the newly created visualizations to populate the dashboard.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-new-dashboard-add-visualizations.png
      :align: center
      :width: 80%
...
#. Save the dashboard by selecting the **Save** option on the top-right navigation bar.
   ...
   .. thumbnail:: /images/cyb3rhq-dashboard/custom-dashboards/create-new-dashboard-save.png
      :align: center
      :width: 80%
