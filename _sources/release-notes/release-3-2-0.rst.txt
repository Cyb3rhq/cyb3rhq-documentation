...
.. meta::
  :description: Cyb3rhq 3.2.0 has been released. Check out our release notes to discover the changes and additions of this release.
...
This section shows the most relevant new features of Cyb3rhq v3.2.0. You will find more detailed information in our `changelog <https://github.com/cyb3rhq/cyb3rhq/blob/v3.2.0/CHANGELOG.md>`_ file.
...
This module provides the ability to read your `AWS CloudTrail` logs directly from an AWS S3 bucket. Amazon CloudTrail support is now a built-in Cyb3rhq feature, giving you the ability to search, analyze, and generate alerts for AWS CloudTrail events.
...
.. code-block:: none
	...
	** Alert 1518488581.32874246: - amazon,authentication_success,pci_dss_10.2.5,
	2018 Feb 13 02:23:01 manager->Cyb3rhq-AWS
	...
	aws.userIdentity.userName: cyb3rhq
	aws.userIdentity.type: IAMUser
	aws.userIdentity.arn: arn:aws:iam::166157441623:user/cyb3rhq
