...
.. meta::
  :description: Cyb3rhq 2.1 has been released. Check out our release notes to discover the changes and additions of this release.
...
This section shows the most relevant new features of Cyb3rhq v2.1. You will find more detailed information in our `changelog <https://github.com/cyb3rhq/cyb3rhq/blob/v2.1.0/CHANGELOG.md>`_ file.
...
The Authd program has been improved in this version such that the Cyb3rhq API and the ``manage_agents`` tools can now register an agent while ``ossec-authd`` is running.
...
External libraries used by Cyb3rhq have been updated to improve their integration with our components.
