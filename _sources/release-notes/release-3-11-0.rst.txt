...
.. meta::
  :description: Cyb3rhq 3.11.0 has been released. Check out our release notes to discover the changes and additions of this release.
...
- `cyb3rhq/cyb3rhq <https://github.com/cyb3rhq/cyb3rhq/blob/v3.11.0/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-api <https://github.com/cyb3rhq/cyb3rhq-api/blob/v3.11.0/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-ruleset <https://github.com/cyb3rhq/cyb3rhq-ruleset/blob/v3.11.0/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-kibana-app <https://github.com/cyb3rhq/cyb3rhq-kibana-app/blob/v3.11.0-7.5.1/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-splunk <https://github.com/cyb3rhq/cyb3rhq-splunk/tree/v3.11.0-8.0.0/CHANGELOG.md>`_
...
- The Cyb3rhq agent now waits until the network service is ready before start.
...
Cyb3rhq WUI for Kibana
---------------------
- Support for Kibana: v6.8.6, v7.5.1.
- Support for OpenDistro: v1.3.0.
- The API credentials configuration has been migrated from the ``.cyb3rhq`` index to the ``cyb3rhq.yml`` configuration file. Now the hosts API configuration is managed from this configuration file instead from the WUI.
- Reporting module events are now logged in the Cyb3rhq WUI logs.
- The index pattern selector is now hidden in case that only one index exists.
- Fixed CSV export for files in a agents group.

Cyb3rhq WUI for Splunk
---------------------
