...
.. meta::
  :description: Cyb3rhq 3.2.1 has been released. Check out our release notes to discover the changes and additions of this release.
...
This release is a bug fix release. This section shows the most relevant improvements and fixes of Cyb3rhq v3.2.1. You will find more detailed information in the `changelog <https://github.com/cyb3rhq/cyb3rhq/blob/v3.2.1/CHANGELOG.md#v321>`_ file.
...
The Cyb3rhq modules include several fixes in this release to improve their performance and reliability. The most relevant changes are described in this section.

To avoid the agent flooding, a maximum of events sent per second has been established for every module.
This limit is configurable by the ``cyb3rhq_modules.max_eps`` parameter of the internal configuration.
...
Cluster
-------
Several bugs have been fixed in the Cyb3rhq cluster, among them, dealing with too long file paths.
