...
.. meta::
  :description: Cyb3rhq 4.0.2 has been released. Check out our release notes to discover the changes and additions of this release.
...
- `cyb3rhq/cyb3rhq <https://github.com/cyb3rhq/cyb3rhq/blob/v4.0.2/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-kibana-app <https://github.com/cyb3rhq/cyb3rhq-kibana-app/blob/v4.0.2-7.9.3/CHANGELOG.md>`_
...
- Authentication with ``run_as`` is now available for other users besides ``cyb3rhq-wui``.
...
- Manager restart in rule editor with Cyb3rhq cluster enabled.
