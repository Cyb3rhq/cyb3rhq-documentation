...
.. meta::
  :description: Cyb3rhq 3.9.4 has been released. Check out our release notes to discover the changes and additions of this release.
...
- `cyb3rhq/cyb3rhq <https://github.com/cyb3rhq/cyb3rhq/blob/v3.9.4/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-kibana-app <https://github.com/cyb3rhq/cyb3rhq-kibana-app/blob/v3.9.4-7.2.0/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-splunk <https://github.com/cyb3rhq/cyb3rhq-splunk/blob/v3.9.4-7.3.0/CHANGELOG.md>`_
...
- Fixed a bug in Cyb3rhq DB that could make it crash when closing database files due to a double free.
...
- Cyb3rhq DB did not remove a database file until was committed. Now, the database will be closed immediately.
...
- Fixed Overview Security Events report when cyb3rhq.monitoring is disabled.
