...
.. meta::
  :description: Cyb3rhq 4.1.1 has been released. Check out our release notes to discover the changes and additions of this release.
...
- `cyb3rhq/cyb3rhq <https://github.com/cyb3rhq/cyb3rhq/blob/v4.1.1/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-kibana-app <https://github.com/cyb3rhq/cyb3rhq-kibana-app/blob/v4.1.1-7.10.0/CHANGELOG.md>`_
...
- Migrated the Cyb3rhq API endpoints for manager and cluster files and their corresponding RBAC.
...
- An issue that prevented from editing empty rules and decoders files that already existed in the Cyb3rhq manager.
...
- Close Cyb3rhq API session when logging out from UI.
