...
.. meta::
  :description: Cyb3rhq 3.13.0 has been released. Check out our release notes to discover the changes and additions of this release.
...
- `cyb3rhq/cyb3rhq <https://github.com/cyb3rhq/cyb3rhq/blob/v3.13.0/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-kibana-app <https://github.com/cyb3rhq/cyb3rhq-kibana-app/blob/3.13-7.7/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-api <https://github.com/cyb3rhq/cyb3rhq-api/blob/3.13/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-ruleset <https://github.com/cyb3rhq/cyb3rhq-ruleset/blob/3.13/CHANGELOG.md>`_
...
- Avoid creating the ``cyb3rhq-monitoring`` index pattern if it is disabled.
...
- Fixed the provider name so that Windows Eventlog's logs match with the Cyb3rhq rules.
