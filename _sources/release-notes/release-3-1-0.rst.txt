...
.. meta::
  :description: Cyb3rhq 3.1.0 has been released. Check out our release notes to discover the changes and additions of this release.
...
This section shows the most relevant new features of Cyb3rhq v3.1.0. You will find more detailed information in our `changelog <https://github.com/cyb3rhq/cyb3rhq/blob/v3.1.0/CHANGELOG.md>`_ file.

**New features:**

- `VULS integration`_
- `CIS-CAT Cyb3rhq module to scan CIS policies`_
- `New "Command" Cyb3rhq module`_
...
.. code-block:: none
   ...
   ** Alert 1513880084.806869: - vuls,
   2017 Dec 21 18:14:44 ip-172-31-42-67->Cyb3rhq-VULS
...
CIS-CAT Cyb3rhq module to scan CIS policies
-----------------------------------------

The new CIS-CAT module was developed for evaluating CIS benchmarks in Cyb3rhq agents. This module assesses an agent's compliance with CIS policies to ensure the application of the best practices in in the security of your IT systems.
...
In large environments, the alerts file may take up a large amount of disk space. To address this, Cyb3rhq 3.1 includes support for rotating the following files by time or size:
...
The Cyb3rhq API has been enhanced with new requests, such as:
...
In addition, more new features can be found in the `API changelog <https://github.com/cyb3rhq/cyb3rhq-api/blob/3.1/CHANGELOG.md>`_.
...
More information on changes to the Ruleset can be found on the `Ruleset changelog <https://github.com/cyb3rhq/cyb3rhq-ruleset/blob/3.1/CHANGELOG.md>`_.


More relevant features
----------------------

Additional features have been added to Cyb3rhq 3.1.0 in order to improve its performance, including, but not limited to:
