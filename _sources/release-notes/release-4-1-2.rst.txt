...
.. meta::
  :description: Cyb3rhq 4.1.2 has been released. Check out our release notes to discover the changes and additions of this release.
...
- `cyb3rhq/cyb3rhq <https://github.com/cyb3rhq/cyb3rhq/blob/v4.1.2/CHANGELOG.md>`_
...
- Issue with overlay of Cyb3rhq menu when Kibana menu is opened or docked is now fixed.
