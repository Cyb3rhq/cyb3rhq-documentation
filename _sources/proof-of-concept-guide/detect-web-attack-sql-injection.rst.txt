...
.. meta::
   :description: Cyb3rhq is capable of detecting an SQL Injection attack from web server logs showing common SQL patterns of attack in a monitored endpoint. Learn more about this in this PoC.

Detecting an SQL injection attack
=================================

You can use Cyb3rhq to detect SQL injection attacks from web server logs that contain patterns like ``select``, ``union``, and other common SQL injection patterns.
...
In this use case, you simulate an SQL injection attack against an Ubuntu endpoint and detect it with Cyb3rhq.
...
Perform the following steps to install Apache and configure the Cyb3rhq agent to monitor the Apache logs.
...
#. Add the following lines to the Cyb3rhq agent ``/var/ossec/etc/ossec.conf`` file. This allows the Cyb3rhq agent to monitor the access logs of your Apache server:
