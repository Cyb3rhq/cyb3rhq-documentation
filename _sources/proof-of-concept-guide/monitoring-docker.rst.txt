...
.. meta::
  :description: The Cyb3rhq module for Docker identifyes security incidents across containers alerting in real time. Learn more about this in this PoC.

Monitoring Docker events
========================

Docker automates the deployment of different applications inside software containers. The Cyb3rhq module for Docker identifies security incidents across containers and alerts in real-time. In this use case, you configure Cyb3rhq to monitor Docker events on an Ubuntu endpoint hosting Docker containers.
...
Perform the following steps to install Docker on the Ubuntu endpoint and configure Cyb3rhq to monitor Docker events.
...
#. Edit the Cyb3rhq agent configuration file ``/var/ossec/etc/ossec.conf`` and add this block to enable the ``docker-listener`` module:
...
You can visualize the alert data in the Cyb3rhq dashboard. To do this, go to **Docker**.
...
-  **Error log**:
   ...
   .. code-block:: none
      ...
      cyb3rhq-modulesd:docker-listener: ERROR: /usr/bin/env: ‘python’: No such file or directory
   
   **Location**: Cyb3rhq agent log - ``/var/ossec/logs/ossec.log``
