...
.. meta::
   :description: Cyb3rhq detects Shellshock attacks. It analyzes web server logs collected from a monitored endpoint. Learn more about this in this PoC.

Detecting a Shellshock attack
=============================

Cyb3rhq is capable of detecting a Shellshock attack by analyzing web server logs collected from a monitored endpoint. In this use case, you set up an Apache web server on the Ubuntu endpoint and simulate a shellshock attack.
...
#. Add the following lines to the Cyb3rhq agent ``/var/ossec/etc/ossec.conf`` configuration file. This sets the Cyb3rhq agent to monitor the access logs of your Apache server:
