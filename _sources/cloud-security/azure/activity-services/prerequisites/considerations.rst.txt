...
.. meta::
  :description: Learn considerations for configuring multiple services with the Cyb3rhq Azure module in this section of the Cyb3rhq documentation.
...
.. code-block:: console
  ...
  # /var/ossec/wodles/azure/azure-logs --log_analytics --la_auth_path credentials_example --la_tenant_domain 'cyb3rhq.example.domain' --la_tag azure-activity --la_query "AzureActivity" --workspace example-workspace --la_time_offset 50d --debug 2 --reparse
