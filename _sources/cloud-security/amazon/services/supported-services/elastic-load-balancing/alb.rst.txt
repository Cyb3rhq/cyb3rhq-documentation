...
.. meta::
  :description: AWS Application Load Balancer is a service that distributes incoming application traffic across multiple targets. Learn how to configure and monitor it with Cyb3rhq.
...
#. Open the Cyb3rhq configuration file (``/var/ossec/etc/ossec.conf``) and add the following block for ALB:
