...
.. meta::
  :description: AWS Server Access Logging is a service that provides detailed records for the requests made to a bucket. Learn how to configure and monitor it with Cyb3rhq.
    ...
    .. code-block:: xml
      ...
      <wodle name="aws-s3">
        ...
        <bucket type="server_access">
          <name>cyb3rhq-aws-wodle</name>       <!-- PUT HERE THE S3 BUCKET CHOSEN IN STEP 5 -->
