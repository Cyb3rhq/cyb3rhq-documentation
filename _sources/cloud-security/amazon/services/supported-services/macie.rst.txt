...
.. meta::
  :description: Amazon Macie is a service that uses machine learning and pattern matching to protect sensitive data. Learn how to configure and monitor it with Cyb3rhq.
...
#. You can select the compression you prefer. Cyb3rhq supports any kind of compression but Snappy. After that, click on **Create new or choose**:
...
Below are some use cases for Cyb3rhq alerts built for S3.
