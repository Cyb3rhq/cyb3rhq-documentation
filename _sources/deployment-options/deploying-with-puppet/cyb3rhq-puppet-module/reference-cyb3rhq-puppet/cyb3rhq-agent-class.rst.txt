...
.. meta::
   :description: Learn about the Cyb3rhq agent class and its variables to configure the Cyb3rhq agent in this section of the Cyb3rhq documentation. 

.. _reference_cyb3rhq_agent_class:
...
This contains variables that can be used to configure the Cyb3rhq agent.
...
$cyb3rhq_enrollment_manager_address
...
$cyb3rhq_enrollment_port
  ...
  `Type String`
   ...
   Depends on **cyb3rhq_enrollment_enabled**

$cyb3rhq_enrollment_agent_name
...
$cyb3rhq_enrollment_agent_address
...
$cyb3rhq_enrollment_server_ca_path
...
$cyb3rhq_enrollment_agent_cert_path
...
$cyb3rhq_enrollment_agent_key_path
  Required when agent verification is enabled in the manager.
...
$cyb3rhq_enrollment_auth_pass_path
...
$cyb3rhq_enrollment_auto_method
...
$cyb3rhq_delay_after_enrollment
...
$cyb3rhq_enrollment_use_source_ip
...
$cyb3rhq_reporting_endpoint
  Specifies the IP address or the hostname of the Cyb3rhq manager to report.

  `Default undef`

  `Type String`
  
$cyb3rhq_register_endpoint
  Specifies the IP address or the hostname of the Cyb3rhq manager to register against. It is used to run the **agent-auth** tool.

  `Type String`

$ossec_port
  Specifies the port to send events to the manager. This must match the associated listening port configured on the Cyb3rhq manager.
