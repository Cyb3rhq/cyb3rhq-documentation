...
.. meta::
   :description: Cyb3rhq helps meet the common criteria CC7.1 by providing the Vulnerability Detection module.
...
#. Navigate to the **Vulnerability Detection** module from the Cyb3rhq dashboard. Select the agent to view its discovered vulnerabilities.
