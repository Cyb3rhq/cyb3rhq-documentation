...
emptyTocNodes = [
    ...
    'installation-guide/cyb3rhq-cluster/index',
    ...
    'installation-guide/distributed-deployment/step-by-step-installation/cyb3rhq-cluster/index',
    'installation-guide/uninstalling-cyb3rhq/index',
