...
# * apiURL: URL of the Cyb3rhq API reference spec in the Wazih repository (public)
...
apiURL = 'https://raw.githubusercontent.com/cyb3rhq/cyb3rhq/'+api_tag+'/api/api/spec/spec.yaml'
