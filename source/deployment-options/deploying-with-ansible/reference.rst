...
.. meta::
  :Description: Ansible is an open source platform designed for automating tasks. Learn more about the variable references in this section of the Cyb3rhq documentation.
  
Variables references
--------------------

.. _cyb3rhq_ansible_reference_indexer:
...
.. _cyb3rhq_ansible_reference_dashboard:
...
| **Description**: Listening IP address of the Cyb3rhq dashboard.
| **Default value**: ``0.0.0.0``
|
| **Variable**: ``dashboard_server_port``
| **Description**: Listening port of the Cyb3rhq dashboard.
| **Default value**: ``443``
|
| **Variable**: ``cyb3rhq_version``
| **Description**: Cyb3rhq dashboard compatible version to install.
| **Default value**: ``|CYB3RHQ_CURRENT_ANSIBLE|``
|

.. _cyb3rhq_ansible_reference_filebeat:
...
.. _cyb3rhq_ansible_reference_manager:

Cyb3rhq Manager
=============

| **Variable**: ``cyb3rhq_manager_fqdn``
| **Description**: Set Cyb3rhq Manager fqdn hostname.
| **Default value**: ``cyb3rhq-manager``
|
| **Variable**: ``cyb3rhq_manager_config_overlay``
| **Description**: Indicates if the role(s) should perform a ``hash_behaviour=merge`` at role runtime, similar to role-distributed ansible.cfg. This provides support for a partially defined cyb3rhq_manager_config while also moving on from the `deprecated hash_behaviour <https://docs.ansible.com/ansible/latest/reference_appendices/config.html#default-hash-behaviour>`_.
| **Default value**: ``true``
|
| **Variable**: ``cyb3rhq_manager_json_output``
...
| **Default value**: ``yes``
|
| **Variable**: ``cyb3rhq_manager_alerts_log``
...
| **Default value**: ``yes``
|
| **Variable**: ``cyb3rhq_manager_logall``
...
| **Default value**: ``yes``
|
| **Variable**: ``cyb3rhq_manager_email_notification``
...
| **Default value**: ``yes``
|
| **Variable**: ``cyb3rhq_manager_mailto``
...
|
| **Variable**: ``cyb3rhq_manager_connection``
...
|
| **Variable**: ``cyb3rhq_manager_syscollector``
...
|
| **Variable**: ``cyb3rhq_manager_vulnerability_detection``
...
|
| **Variable**: ``cyb3rhq_manager_localfiles``
...
|
| **Variable**: ``cyb3rhq_manager_api``
| **Description**: Configures the :doc:`Cyb3rhq API </user-manual/api/configuration>` file called ``api.yaml``.
| **Default values**:
...
|
| **Variable**: ``cyb3rhq_api_user``
| **Description**: Cyb3rhq API credentials.
| **Example**:
...
.. warning::
    ...
    We recommend the use of `Ansible Vault <https://docs.ansible.com/ansible/latest/user_guide/vault.html>`_ to protect Cyb3rhq agentless and authd credentials.

|
| **Variable**: ``cyb3rhq_manager_config``
| **Description**: Stores the Cyb3rhq Manager configuration. This variable is provided for backward compatibility. Newer deployments should use the newly introduced variables described above.
| **Example**:
...
.. code-block:: yaml
    ...
    cyb3rhq_manager_config:
      ...
      mail_from: cyb3rhq-manager@example.com
      extra_emails:
        - enable: false
      ...
      commands:
        ...
        - name: 'restart-cyb3rhq'
          executable: 'restart-cyb3rhq'
          timeout_allowed: 'no'
        - name: 'win_restart-cyb3rhq'
          executable: 'restart-cyb3rhq.exe'
          timeout_allowed: 'no'
        - name: 'firewall-drop'
          executable: 'firewall-drop'
          timeout_allowed: 'yes'
        ...
        - name: 'win_route-null'
          ...
          timeout_allowed: 'yes'
      active_responses:
        - command: 'restart-cyb3rhq'
          location: 'local'
          rules_id: '100002'
        - command: 'win_restart-cyb3rhq'
          location: 'local'
          rules_id: '100003'
        - command: 'host-deny'
          location: 'local'
...
|
| **Variable**: ``cyb3rhq_agent_configs``
| **Description**: This stores the different settings and profiles for centralized agent configuration via Cyb3rhq Manager.
| **Example**:
...
|
| **Variable**: ``cdb_lists``
| **Description**: Configure CDB lists used by the Cyb3rhq Manager.
| **Example**:
...
|
| **Variable**: ``authd_pass``
| **Description**: Cyb3rhq authd service password.
| **Example**:
...
.. _cyb3rhq_ansible_reference_agent:

Cyb3rhq Agent
===========

| **Variable**: ``cyb3rhq_managers``
| **Description**: Set the Cyb3rhq Manager servers IP address, protocol, and port to be used by the agent. If a specific manager is used for registration, we can indicate which one it is by adding the register option set to true. If the register option is missing, the first manager on the list will be used for registration.
| **Example**:
...
|
| **Variable**: ``cyb3rhq_agent_nolog_sensible``:
...
| **Default value**: ``yes``
|
| **Variable**: ``cyb3rhq_agent_config_overlay``:
| **Description**: This variable apply an additional configuration combined with the default configuration.
| **Default value**: ``yes``
|
| **Variable**: ``cyb3rhq_agent_api_validate``
| **Description**: After registering the agent through the REST API, validate that registration is correct.
| **Default value**: ``yes``
|
| **Variable**: ``cyb3rhq_agent_address``
| **Description**: Establish which IP address we want to associate with this agent. It can be an address or “any” This variable will supersede cyb3rhq_agent_nat.
| **Default value**: ``ansible_default_ipv4.address``
|
| **Variable**: ``cyb3rhq_profile_centos``
...
.. code-block:: yaml
    ...
    cyb3rhq_profile: "centos7, centos7"

|
| **Variable**: ``cyb3rhq_profile_ubuntu``
...
.. code-block:: yaml
    ...
    cyb3rhq_profile: "ubuntu, ubuntu18"
    
|
| **Variable**: ``cyb3rhq_agent_authd``
| **Description**: Set the agent-authd facility. This will enable or not the automatic agent registration, you could set various options in accordance with the authd service configured in the Cyb3rhq Manager. This Ansible role will use the address defined on ``registration_address`` as the authd registration server.
| **Example**:
...
|
| **Variable**: ``cyb3rhq_auto_restart``
| **Description**: Set the ``<auto_restart>`` option in the agent.
| **Default value**: ``null``
|
| **Variable**: ``cyb3rhq_notify_time``
| **Description**: Set the ``<notify_time>`` option in the agent.
| **Default value**: ``null``
|
| **Variable**: ``cyb3rhq_crypto_method``
| **Description**: Set ``<crypto_method>`` option in the agent.
| **Default value**: ``null``
|
| **Variable**: ``cyb3rhq_time_reconnect``
| **Description**: Set ``<time-reconnect>`` option in the agent.
| **Default value**: ``null``
|
| **Variable**: ``cyb3rhq_winagent_config``
| **Description**: Set the Cyb3rhq Agent installation regarding Windows hosts.
| **Example**:

.. code-block:: yaml

    cyb3rhq_winagent_config:
      download_dir: C:\
...
|
| **Variable**: ``cyb3rhq_agent_client_buffer``
...
.. code-block:: yaml
    ...
    cyb3rhq_agent_client_buffer:
      disable: 'no'
      queue_size: '5000'
      events_per_sec: '500'

|
| **Variable**: ``cyb3rhq_agent_rootcheck``
| **Description**: Configures the :doc:`rootcheck </user-manual/reference/ossec-conf/rootcheck>` section from agent ``ossec.conf``.
| **Example**:

.. code-block:: yaml

    cyb3rhq_agent_rootcheck:
      frequency: 43200

|
| **Variable**: ``cyb3rhq_agent_openscap``
| **Description**: Configures the :doc:`wodle </user-manual/reference/ossec-conf/wodle-openscap>` item named ``open-scap`` from ``ossec.conf``.
| **Default values**:

.. code-block:: yaml

    cyb3rhq_agent_openscap:
      disable: 'yes'
      timeout: 1800
      interval: '1d'
      scan_on_start: 'yes'
...
|
| **Variable**: ``cyb3rhq_agent_cis_cat``
| **Description**: Configures the :doc:`wodle </user-manual/reference/ossec-conf/wodle-ciscat>` item named ``cis-cat`` from ``ossec.conf``.
| **Default values**:

.. code-block:: yaml

    cyb3rhq_agent_cis_cat:
      disable: 'yes'
      install_java: 'no'
      timeout: 1800
      interval: '1d'
...
|
| **Variable**: ``cyb3rhq_agent_osquery``
| **Description**: Configures the :doc:`wodle</user-manual/reference/ossec-conf/wodle-osquery>` item named ``osquery`` from ``ossec.conf``.
| **Default values**:

.. code-block:: yaml

    cyb3rhq_agent_osquery:
      disable: 'yes'
      run_daemon: 'yes'
...
|
| **Variable**: ``cyb3rhq_agent_syscollector``
| **Description**: Configures the :doc:`wodle </user-manual/reference/ossec-conf/wodle-syscollector>` item named ``syscollector`` from ``ossec.conf``.
| **Default values**:

.. code-block:: yaml

    cyb3rhq_agent_syscollector:
      disable: 'no'
      interval: '1h'
      scan_on_start: 'yes'
      hardware: 'yes'
...
|
| **Variable**: ``cyb3rhq_agent_syscheck``
| **Description**: Configures the :doc:`syscheck </user-manual/reference/ossec-conf/syscheck>` section from ``ossec.conf``.
| **Default values**:

.. code-block:: yaml

    cyb3rhq_agent_syscheck:
      frequency: 43200
      scan_on_start: 'yes'
      auto_ignore: 'no'
...
|
| **Variable**: ``cyb3rhq_agent_labels``
| **Description**: Configures the :doc:`labels </user-manual/reference/ossec-conf/labels>` section from ``ossec.conf``.
| **Default values**:

.. code-block:: yaml

    cyb3rhq_agent_labels:
      enable: false
      list:
        - key: Env
          value: Production
...
|
| **Variable**: ``cyb3rhq_agent_log_format``
| **Description**: Configures the :doc:`log_format </user-manual/reference/ossec-conf/logging>` section from ``ossec.conf``.
| **Default value**: ``plain``
|
| **Variable**: ``cyb3rhq_agent_config_defaults``
| **Description**: Cyb3rhq Agent related configuration. This variable is provided for backward compatibility. Newer deployments should use the newly introduced variables described above.
| **Example**:

.. code-block:: yaml

    cyb3rhq_agent_config_defaults:
      repo: '{{ cyb3rhq_repo }}'
      active_response: '{{ cyb3rhq_agent_active_response }}'
      log_format: '{{ cyb3rhq_agent_log_format }}'
      client_buffer: '{{ cyb3rhq_agent_client_buffer }}'
      syscheck: '{{ cyb3rhq_agent_syscheck }}'

      rootcheck: '{{ cyb3rhq_agent_rootcheck }}'
      openscap: '{{ cyb3rhq_agent_openscap }}'

      osquery: '{{ cyb3rhq_agent_osquery }}'
      syscollector: '{{ cyb3rhq_agent_syscollector }}'
      sca: '{{ cyb3rhq_agent_sca }}'
      cis_cat: '{{ cyb3rhq_agent_cis_cat }}'
      localfiles: '{{ cyb3rhq_agent_localfiles }}'

      labels: '{{ cyb3rhq_agent_labels }}'
      enrollment: '{{ cyb3rhq_agent_enrollment }}'
...
| **Variable**: ``authd_pass``
| **Description**: Cyb3rhq authd credentials for agent registration.
| **Example**:
