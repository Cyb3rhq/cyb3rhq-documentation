...
.. meta::
   :description: Learn how to install the Puppet server in this section of the Cyb3rhq documentation. 
...
The manifest supports the following releases to install cyb3rhq.
