...
.. meta::
   :description: You can customize the Cyb3rhq decoders on the Cyb3rhq server to suit your requirements and improve your detection capabilities.
  
Custom decoders
===============

You can customize the Cyb3rhq decoders on the Cyb3rhq server to suit your requirements and improve your detection capabilities. Cyb3rhq allows you to:
...
#. Run ``/var/ossec/bin/cyb3rhq-logtest`` utility on the Cyb3rhq server and enter the example log above to test the decoder and rule:
   ...
   To test your rules and decoders using the ``/var/ossec/bin/cyb3rhq-logtest`` utility, simply save the changes made to the decoder and rule files. However, you need to restart the Cyb3rhq manager to generate alerts based on these modifications.
...
To modify a default decoder, you can rewrite its file in the ``/var/ossec/etc/decoders/`` directory on the Cyb3rhq server, make the changes, and exclude the original decoder file from the loading list.
