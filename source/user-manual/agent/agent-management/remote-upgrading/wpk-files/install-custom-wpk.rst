...
.. meta::
   :description: Learn about the steps to upgrade a Cyb3rhq agent using a custom WPK file in a WPK repository.

Installing a custom WPK
=======================

Follow the steps below to upgrade a Cyb3rhq agent using a custom WPK file in a WPK repository:

#. Install the root CA into the Cyb3rhq agent. The root CA certificate or the certificate used to sign the WPK package must be installed in the Cyb3rhq agent before an upgrade.
   ...
   -  Overwrite the shipped root CA with your certificate.
      ...
      .. note::
         ...
         Overwriting the shipped root CA will prevent your agent from upgrading using WPK packages from the Cyb3rhq manager.
...
#. Initiate the upgrade by running this command on the Cyb3rhq server:
   ...
   .. code-block:: none
      ...
      Upgraded agents:
          Agent 001 upgraded: Cyb3rhq v4.7.2 -> Cyb3rhq v4.8.0
