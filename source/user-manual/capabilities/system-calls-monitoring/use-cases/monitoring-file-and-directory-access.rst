...
#. Run the commands below to configure the following audit rules:
   ...
   .. code-block:: console
      ...
      # echo "-w /home -p w -k audit-cyb3rhq-w" >> /etc/audit/audit.rules
      # echo "-w /home -p a -k audit-cyb3rhq-a" >> /etc/audit/audit.rules
      # echo "-w /home -p r -k audit-cyb3rhq-r" >> /etc/audit/audit.rules
      # echo "-w /home -p x -k audit-cyb3rhq-x" >> /etc/audit/audit.rules
...
#. Reload the audit rules to apply the changes:
   ...
   .. code-block:: console   
      ...
      -w /home -p w -k audit-cyb3rhq-w
      -w /home -p a -k audit-cyb3rhq-a
      -w /home -p r -k audit-cyb3rhq-r
      -w /home -p x -k audit-cyb3rhq-x

Audit configuration alerts are displayed in the **Threat Hunting** module of the Cyb3rhq dashboard. 
...
You can visualize the alert data in the Cyb3rhq dashboard. To do this, go to the **Threat Hunting** module and apply the ``rule.id:80790`` filter to query the alert.
...
You can visualize the alert data in the Cyb3rhq dashboard. To do this, go to the **Threat Hunting** module and apply the ``rule.id:80784`` filter to query the alert.
...
You can visualize the alert data in the Cyb3rhq dashboard. To do this, go to the **Threat Hunting** module and apply the ``rule.id:80787`` filter to query the alert.
...
You can visualize the alert data in the Cyb3rhq dashboard. To do this, go to the **Threat Hunting** module and apply the ``rule.id: (80784 or 80789)`` filters to query the alerts.
...
You can visualize the alert data in the Cyb3rhq dashboard. To do this, go to the **Threat Hunting** module and apply the ``rule.id:80791`` filter to query the alert.
