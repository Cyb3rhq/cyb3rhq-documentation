...
.. meta::
  :description: Learn more about Cyb3rhq Agentless monitoring with use cases in this section of the Cyb3rhq documentation.
...
#. Restart the Cyb3rhq manager with the following command to apply the changes: 
...
- Navigate to **Threat Hunting** on the Cyb3rhq dashboard. Search for ``agentless.host:*`` to view the alert generated. 
