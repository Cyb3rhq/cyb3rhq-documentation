...
.. meta::
  :description: Learn more about the OpenSCAP wodle, an integration of OpenSCAP with Cyb3rhq HIDS that provides the ability to perform configuration and vulnerability scans of an agent. 
...
In this example, we configure Cyb3rhq to run OpenSCAP each day, with a timeout of 30 minutes. ::
