...
.. meta::
  :description: You can generate two types of reports from the Cyb3rhq dashboard. Learn more about it in this section of the Cyb3rhq documentation. 

Generating system inventory reports
===================================

You can generate two types of reports from the Cyb3rhq dashboard. These reports are the property-specific report and the endpoint inventory report. 
...
This feature allows you to export a full report of all endpoint properties collected by the Cyb3rhq Syscollector module. This report is generated in PDF format and can serve a variety of uses. To download the full endpoint report:

- Click on **Generate Report** on the **Inventory data** page of the Cyb3rhq agent.
