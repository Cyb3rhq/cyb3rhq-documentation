...
.. meta::
  :description: Find out how to configure the Cyb3rhq Microsoft Graph module. Learn more about it in this section of the Cyb3rhq documentation.
...
.. note::
    ...
    When Cyb3rhq starts, the module will wait for the duration of the configured time interval before running the first scan unless ``run_on_start`` is set to **yes**.
