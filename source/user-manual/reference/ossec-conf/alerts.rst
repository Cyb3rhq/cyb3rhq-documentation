...
This option has no effect and will result in a parsing error unless compiled with `LIBGEOIP_ENABLED <https://github.com/cyb3rhq/cyb3rhq/blob/master/src/config/alerts-config.c#L61>`_.
