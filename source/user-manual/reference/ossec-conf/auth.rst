...
.. meta::
  :description: This section of the Cyb3rhq Documentation shows the options for the agents registration service.
...
Specifies the path to the CA certificate used to verify clients. It can be referred to a relative path under the Cyb3rhq installation directory or a full path.
...
Specifies the path to the server SSL certificate. It can be referred to a relative path under the Cyb3rhq installation directory or a full path.
...
Specifies the path to the server's SSL key. It can be referred to a relative path under the Cyb3rhq installation directory or a full path.
