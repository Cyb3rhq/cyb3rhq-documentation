...
.. meta::
  :description: Find out how to configure the agent bucket parameters in order to avoid events flooding. Learn more about it in this section of the Cyb3rhq documentation.
