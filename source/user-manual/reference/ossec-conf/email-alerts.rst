...
.. note::
   ...
   Also, check that the rule group in your rule definitions ends with a comma as well. For example, ``<group>group_b,</group>``. This is usually the case in the Cyb3rhq default ruleset.
