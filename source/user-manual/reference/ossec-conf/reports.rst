...
.. meta::
  :description: Learn more about the different options for configuring daily reports based on alerts in this section of the Cyb3rhq documentation.  
...
| **Default value**  | n/a                                                                                                                                               | 
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| **Allowed values** | Any Rule ID in Cyb3rhq Rules is allowed.                                                                                                            |
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
