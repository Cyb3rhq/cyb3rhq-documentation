...
.. meta::
  :description: Learn more about the configuration options for policy monitoring and anomaly detection in the rootcheck section of the Cyb3rhq documentation.
