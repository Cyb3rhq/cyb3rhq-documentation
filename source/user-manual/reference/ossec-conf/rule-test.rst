...
.. meta::
  :description: Find out how to configure the cyb3rhq-logtest solution to test rules and decoders. Learn more about it in this section.
...
Here is how to configure the Cyb3rhq-Logtest solution. It allows to test rules and decoders from Cyb3rhq API and :ref:`cyb3rhq-logtest tool <cyb3rhq-logtest>`
...
Number of Cyb3rhq-Logtest solution threads.
