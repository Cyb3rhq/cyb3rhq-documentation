...
.. meta::
  :description: Cyb3rhq agentless monitoring allows you to run integrity checks on systems without an agent installed. Check out this section of the documentation. 
...
|                    |                           |                                                                        |
+                    +---------------------------+ Cyb3rhq will integrity scan the files in the specified directories.      +
...
| **Default value**  | n/a                                                                                              |
+--------------------+---------------+----------------------------------------------------------------------------------+
| **Allowed values** | periodic      | Output from each check is analyzed with the Cyb3rhq ruleset as if a monitored log. |
+                    +---------------+----------------------------------------------------------------------------------+
