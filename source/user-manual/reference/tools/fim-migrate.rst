...
.. meta::
  :description: Migrate FIM databases older than Cyb3rhq v3.7.0 to the new format included in Cyb3rhq-DB using the fim_migrate tool. Learn more about it in this section.
...
The *fim_migrate* tool allows to migrate FIM databases older than Cyb3rhq v3.7.0 to the new format included in Cyb3rhq-DB. This tool must be executed after the :ref:`upgrading process <upgrading_cyb3rhq_server>` has been completed.
...
This tool is not included in the Cyb3rhq installation, but you can download it from the Cyb3rhq repository on GitHub:

.. code-block:: console

    # curl -so fim_migrate https://raw.githubusercontent.com/cyb3rhq/cyb3rhq/v|CYB3RHQ_CURRENT|/tools/migration/fim_migrate.py
