...
.. meta::
  :description: Learn how the Cyb3rhq core uses list-based databases to store information related to agent keys, and FIM/Rootcheck event data in this section.
...
The Cyb3rhq core uses list-based databases to store information related to agent keys, and FIM/Rootcheck event data.
...
Tables available for cyb3rhq-db
=============================
