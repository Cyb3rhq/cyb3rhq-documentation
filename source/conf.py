...
project = u'Cyb3rhq'
author = u'Cyb3rhq, Inc.'
copyright = u'&copy; ' + str(datetime.datetime.now().year) + u' Cyb3rhq Inc.'
...
extensions = [
    ...
    'sphinx_tabs.tabs',
    'cyb3rhq-doc-images', # Custom extension
    'sphinx_reredirects'
]
...
html_theme = 'cyb3rhq_doc_theme_v3'
...
# of the sidebar.
html_logo = theme_assets_path + '/static/images/cyb3rhq-logo.png'
...
latex_documents = [
    (master_doc, 'Cyb3rhqDocs.tex', u'Documentation', u'Cyb3rhq, Inc.', 'manual'),
]
...
man_pages = [
    (master_doc, 'cyb3rhqdocs', u'Documentation', [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Cyb3rhqDocs', u'Documentation', author, 'Cyb3rhq', 'Documentation', 'Miscellaneous'),
]
...
def manage_assets(app, pagename, templatename, context, doctree):
    ...
    individual_js_files = {
        ...
        "cyb3rhq-documentation": static + "js/min/cyb3rhq-documentation.min.js?ver=%s" % os.stat(os.path.join(theme_dir, "static/js/min/cyb3rhq-documentation.min.js")).st_mtime,
    ...
    def get_css_by_page(pagename):
        ...
        default = "css/min/cyb3rhq-documentation.min.css?ver=%s" % os.stat(os.path.join(theme_dir, "static/css/min/cyb3rhq-documentation.min.css")).st_mtime
    ...
    def get_js_by_page(pagename):
        ...
        default = [
            individual_js_files['redirects'],
            individual_js_files['cyb3rhq-documentation']
            # tabs (extension)
            # lightbox (extension)
        ]
...
def creating_file_list(app, exception):
    ...
    if app.builder.name == 'html':
        ...
        for compiled_html in list_compiled_html:
            sitemap += '\t<url><loc>' + requote_uri(html_theme_options.get('cyb3rhq_doc_url') + '/' + sitemap_version + '/' + compiled_html) + '</loc></url>' + separator
...
html_context = {
    "display_github": True,
    "github_user": "cyb3rhq",
    "github_repo": "cyb3rhq-documentation",
    "conf_py_path": "/source/",
