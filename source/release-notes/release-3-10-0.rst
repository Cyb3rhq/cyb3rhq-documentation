...
.. meta::
  :description: Cyb3rhq 3.10.0 has been released. Check out our release notes to discover the changes and additions of this release.
...
- `cyb3rhq/cyb3rhq <https://github.com/cyb3rhq/cyb3rhq/blob/v3.10.0/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-api <https://github.com/cyb3rhq/cyb3rhq-api/blob/v3.10.0/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-ruleset <https://github.com/cyb3rhq/cyb3rhq-ruleset/blob/v3.10.0/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-kibana-app <https://github.com/cyb3rhq/cyb3rhq-kibana-app/blob/v3.10.0-7.3.2/CHANGELOG.md>`_
- `cyb3rhq/cyb3rhq-splunk <https://github.com/cyb3rhq/cyb3rhq-splunk/blob/v3.10.0-7.3.0/CHANGELOG.md>`_
...
- New corresponding fields in the Cyb3rhq Elastic Stack template.
...
.. thumbnail:: ../images/release-notes/3.10.0/HIPAA.png
  :title: Cyb3rhq App HIPAA Dashboard
  :align: center
  :width: 100%

.. thumbnail:: ../images/release-notes/3.10.0/NIST.png
  :title: Cyb3rhq App NIST Dashboard
  :align: center
  :width: 100%
  ...
  .. code-block:: js
      ...
      "data": {
          ...
          "agent_version": {
              "items": [
                  {
                  "version": "Cyb3rhq v3.10.0",
                  "count": 1
                  },
                  {
                  "version": "Cyb3rhq v3.9.5",
                  "count": 5
                  }
              ],
              "totalItems": 6
...
- Cyb3rhq Kibana app now works as a native plugin and can be safely hidden/displayed depending on the selected space.
...
- Cyb3rhq Splunk app has been adapted for Microsoft Edge Browser.
...
- Export all the information of a Cyb3rhq group and its related agents in a PDF document.
