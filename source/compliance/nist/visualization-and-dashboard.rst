...
.. meta::
  :description: Cyb3rhq offers a web dashboard for continuous data visualization and analysis. Learn more about it in this section of the documentation.

Visualization and dashboard
===========================

Cyb3rhq offers a web dashboard for continuous data visualization and analysis. The Cyb3rhq dashboard comes with out-of-the-box modules for: threat hunting, regulatory compliance, detected vulnerable applications, file integrity monitoring, configuration assessment results, and cloud infrastructure monitoring. It helps perform forensic and historical alert analyses.

The :doc:`Cyb3rhq dashboard </getting-started/components/cyb3rhq-dashboard>` assists in meeting the following NIST 800-53 controls:
...
The Cyb3rhq dashboard module provides dashboards for continuously monitoring and reviewing security incidents and generating reports of security and audit events. The Cyb3rhq dashboard and its NIST 800-53 module help you meet the above NIST 800-53 controls.
...
This use case shows how Cyb3rhq helps meet the **CA-7 Continuous monitoring** NIST requirement by providing security reporting to administrators. Use the Cyb3rhq dashboard to generate a report of all successful authentications in the last 24 hours:

#. Go to the Cyb3rhq dashboard menu and select **Discover** under **Explore**.
...
In this use case, Cyb3rhq assists security administrators in meeting the **AU-6 Audit record review, analysis, and reporting** requirement by providing a NIST 800-53 compliance dashboard.

#. Select the **NIST 800-53** module from your Cyb3rhq dashboard.
...
#. Select the **Controls** tab to view available control requirements. 
   ...
   The **Controls** section of the NIST 800-53 compliance dashboard shows the various NIST 800-53 controls and the related events. For ease of navigation, the Cyb3rhq dashboard groups events according to the NIST 800-53 control they meet or violate.
