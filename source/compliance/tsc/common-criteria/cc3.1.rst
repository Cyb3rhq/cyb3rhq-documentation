...
Use case: Utilizing Cyb3rhq detection and response capabilities for security monitoring
-------------------------------------------------------------------------------------

Cyb3rhq includes several out-of-the-box modules that help meet the *COSO Principle 6 CC3.1* requirement. These modules provide capabilities for vulnerability assessment, configuration assessment, threat intelligence, and regulatory compliance, to mention a few. The analysis from these modules can be viewed from the Cyb3rhq dashboard for easy identification and risk assessment.

Using the Cyb3rhq dashboard, you can review events and alerts generated across your environment.
