...
#. Cyb3rhq pulls the logs from the CloudWatch log groups using the CloudWatch Logs integration.

The following sections cover how to configure AWS to store the scan findings in CloudWatch Logs and how to ingest them into Cyb3rhq.
...
#. Open the Cyb3rhq configuration file (``/var/ossec/etc/ossec.conf``) and add the following configuration block:
...
#. Restart Cyb3rhq to apply the configuration changes.

    * If you are configuring a Cyb3rhq manager:

      .. include:: /_templates/common/restart_manager.rst

    * If you are configuring a Cyb3rhq agent:
