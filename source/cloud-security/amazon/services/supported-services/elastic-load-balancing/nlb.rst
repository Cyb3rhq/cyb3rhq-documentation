...
.. meta::
  :description: Amazon NLB automatically distributes the incoming traffic across multiple targets. Learn how to use Amazon NLB with Cyb3rhq in this section.
...
#. Open the Cyb3rhq configuration file (``/var/ossec/etc/ossec.conf``) and add the following block for NLB:
