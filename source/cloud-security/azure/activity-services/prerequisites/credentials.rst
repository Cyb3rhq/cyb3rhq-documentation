...
.. meta::
  :description: Learn what you need to provide access credentials to the Cyb3rhq Azure module so it can successfully connect to Azure in this section of the Cyb3rhq documentation.

Configuring Azure credentials
=============================

It is necessary to provide access credentials to the Cyb3rhq Azure module so it can successfully connect to Azure. The credentials required vary depending on the type of monitoring.
