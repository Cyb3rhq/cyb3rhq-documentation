...
.. meta::
  :description: Get answers to the most frequently asked questions about billing in this FAQ. Explore the potential of Cyb3rhq Cloud and the Cyb3rhq Cloud Console.
...
- `What are the available payment methods on Cyb3rhq Cloud?`_

- `Can I get a refund?`_

- `What is included in my Cyb3rhq Cloud environment?`_
...
What are the available payment methods on Cyb3rhq Cloud?
--------------------------------------------------------------

Credit or debit card payments are supported. To learn more about Cyb3rhq supported cards, see the certified payment processor list of card brands in the `Stripe documentation <https://stripe.com/docs/payments/cards/supported-card-brands>`_.


Can I get a refund?
-------------------

Charges are nonrefundable, but if you want to cease using an environment, you can :doc:`cancel your environment </cloud-service/your-environment/cancel-environment>` anytime. No new charges are incurred beyond the current billing period. For any special considerations regarding a refund, contact us through the **Help** section of the Cyb3rhq Cloud Console.

What is included in my Cyb3rhq Cloud environment?
-----------------------------------------------

A full set-up of Cyb3rhq, according to your setting, and a standard or premium support service.

How can I request more information?
-----------------------------------

You can contact the Cyb3rhq team anytime through the **Help** section on your Cyb3rhq Cloud Console.
