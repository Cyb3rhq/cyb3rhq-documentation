...
The environment is configured with the `limits eps option <https://documentation.cyb3rhq.com/current/user-manual/reference/ossec-conf/global.html#limits>`_ using the following parameters:
